...
''' Test script for running representative products using data and comparison outputs from geoips_test_data_smos '''

import logging
LOG = logging.getLogger(__name__)


def autotest_smos(fnames, command_line_args=None):
    ''' Pass through script to take command line arguments, and create calls to all smos drivers
