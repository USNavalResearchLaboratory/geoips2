...
''' Test script for running representative products using data and comparison outputs from geoips_test_data_sar '''

import logging
LOG = logging.getLogger(__name__)


def autotest_sar(fnames, command_line_args=None):
    ''' Pass through script to take command line arguments, and create calls to all SAR drivers
