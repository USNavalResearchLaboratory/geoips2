...
###     * Checks that the return from both the run_procflow and cp commands were 0
###         * exit entire script with return code 1 upon any non-zero return code
#######################################################################################################################


retval=0
avfunc=$GEOIPS2/docs/images/available_functionality
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*modis*
check_returns $retval $output_image
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*hy*
check_returns $retval $output_image
...
run_procflow $GEOIPS2_BASEDIR/test_data/test_data_abi_day/data/goes17_20210718_0150/OR_ABI-L1b-RadF-M6C14_G17_s20211990150319_e20211990159386_c20211990159442.nc \
             --procflow single_source \
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*goes-17*
check_returns $retval $output_image
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*goes-16*
check_returns $retval $output_image
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*ahi*
check_returns $retval $output_image
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*ews*
check_returns $retval $output_image
...
run_procflow $GEOIPS2_BASEDIR/test_data/test_data_viirs/data/jpss/20210209/073600/VJ102IMG.A2021040.0736.002.2021040145245.nc \
             $GEOIPS2_BASEDIR/test_data/test_data_viirs/data/jpss/20210209/073600/VJ103IMG.A2021040.0736.002.2021040142228.nc \
             $GEOIPS2_BASEDIR/test_data/test_data_viirs/data/jpss/20210209/074200/VJ102IMG.A2021040.0742.002.2021040143010.nc \
             $GEOIPS2_BASEDIR/test_data/test_data_viirs/data/jpss/20210209/074200/VJ103IMG.A2021040.0742.002.2021040140938.nc \
             --procflow single_source \
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*jpss*
check_returns $retval $output_image
...
cp_retval=$?
retval=$((curr_retval+cp_retval+retval))
ls -lh $GEOIPS2/docs/images/available_functionality/*npp*
check_returns $retval $output_image
