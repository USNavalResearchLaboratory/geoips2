...
# set of arguments.
run_procflow $GEOIPS2_BASEDIR/test_data/test_data_sar/data/STAR_SAR_20181025203206_WP312018_31W_FIX_3km.nc \
          ...
          --trackfiles $GEOIPS2/tests/sectors/bwp312018.dat \
          --compare_path "$GEOIPS2/tests/outputs/sar_<product>" \
