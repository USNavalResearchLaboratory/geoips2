...
run_procflow $GEOIPS2_BASEDIR/test_data/test_data_scat/data/metopc_knmi_125/ascat_20210421_010000_metopc_12730_eps_o_coa_3203_ovw.l2.nc \
          ...
          --tc_template_yaml $GEOIPS2/geoips2/yaml_configs/sectors_dynamic/tc_web_ascat_high_barbs_template.yaml \
          --trackfile_parser bdeck_parser \
          --trackfiles $GEOIPS2/tests/sectors/bwp022021.dat \
          --compare_path "$GEOIPS2/tests/outputs/ascat_knmi_<product>" \
