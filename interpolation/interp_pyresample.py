...
def get_data_box_definition(source_name, lons, lats):
    ...
    from geoips2.interpolation.boxdefinitions import MaskedCornersSwathDefinition
    from geoips2.interpolation.boxdefinitions import PlanarPolygonDefinition
...
def interp_kd_tree(list_of_arrays, area_definition, data_box_definition, radius_of_influence,
                   interp_type='nearest', sigmas=None):
