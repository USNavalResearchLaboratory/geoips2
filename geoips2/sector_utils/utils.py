...
from geoips2.sector_utils.tc_tracks import set_tc_area_def
...
def get_trackfile_area_defs(trackfiles, trackfile_parser,
    ...
    Args:
        ...
        trackfile_sectorlist (list) :
            * DEFAULT None
            * list of sector names to process, of format: tc2020io01amphan.
            * If 'all' contained in list, process all matching TC sectors.
    ...
    from geoips2.sector_utils.tc_tracks import trackfile_to_area_defs
...
def get_static_area_defs_for_xarray(xarray_obj, sectorfiles, sectorlist):
    ...
    Args:
        ...
        sectorfiles (list) : list of sectorfiles
...
def get_tc_area_defs_for_xarray(xarray_obj, tcdb_sectorlist=None,
    ...
    area_defs = []
    from datetime import timedelta
    from geoips2.sector_utils.tc_tracks_database import get_all_storms_from_db
