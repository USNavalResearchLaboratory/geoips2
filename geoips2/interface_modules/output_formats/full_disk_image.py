...
def full_disk_image(area_def,
    ...
    fig, main_ax, mapobj = create_figure_and_main_ax_and_mapobj(x_size, y_size, area_def, existing_mapobj=mapobj)

    # Plot the actual data on a map

    main_ax.imshow(plot_data,
