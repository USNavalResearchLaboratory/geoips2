...
from geoips2.dev.output_config import get_output_format_kwargs
from geoips2.dev.output_config import get_output_format
from geoips2.dev.output_config import get_minimum_coverage
from geoips2.dev.output_config import produce_current_time
...
def config_based(fnames, command_line_args=None):
    ...
    from geoips2.interface_modules.procflows.single_source import plot_data, combine_filename_extra_fields
                    ...
                    if product_db:
                        for fprod in curr_products.keys():
                            ...
                            if ext == 'yaml':
                                ...
                                final_products[cpath]['database writes'] += products_added
