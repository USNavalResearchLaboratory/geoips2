...
def cmap_37H_Legacy(data_range=[180, 280]):
    ...
    transition_vals = [(min_tb, 195),
                       ...
                       (240, 260),
                       (260, max_tb)]
    transition_colors = [('#80007F', '#0080FF'),
                         ('#0080FF', '#3AB9FF'),
                         ('#3AB9FF', '#7DFDFF'),
                         ('#7DFDFF', '#80FF82'),
                         ('#80FF82', '#FFFF80'),
    ...
    mpl_cmap = create_linear_segmented_colormap('cmap_37ghz_legacy',
                                                min_tb,
                                                max_tb,
                                                transition_vals,
                                                transition_colors)
