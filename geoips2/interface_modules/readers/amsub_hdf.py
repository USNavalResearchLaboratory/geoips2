...
def amsub_hdf(fnames, metadata_only=False, chans=None, area_def=None, self_register=False):
   ...
   '''
    ...
    for i in range(nscan):
        time_scan[i:]='%04d%03d%02d%02d' % (year[i][0],jday[i][0],hour[i][0],minute[i][0])
