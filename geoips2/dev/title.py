...
''' Interface Under Development.  Please provide feedback to geoips@nrlmry.navy.mil
    ...
    Wrapper functions for geoips2 title format interfacing.
...
def get_remove_duplicates_func(title_func_name):
    ...
    See: geoips2.dev.title.is_valid_title for full list of supported title function call signatures and return values
...
def list_titles_by_type():
    ...
    See geoips2.dev.title.is_valid_title? for a list of available title format types and
            associated call signatures / return values.
    See geoips2.dev.title.get_title(title_func_name) to retrieve the requested title format function
...
def test_title_interface():
    ''' Finds and opens every title func available within the current geoips2 instantiation

    See geoips2.dev.title.is_valid_title? for a list of available title func types and associated
            call signatures / return values.
    See geoips2.dev.title.get_title(title_func_name) to retrieve the requested title func

    Returns:
        (list) : List of all successfully opened geoips2 title funcs
    '''
