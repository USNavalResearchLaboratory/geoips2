...
''' Interface Under Development.  Please provide feedback to geoips@nrlmry.navy.mil
    ...
    Wrapper functions for geoips2 boundaries plotting parameter specifications
...
def get_boundaries(boundaries_name):
    ...
    See: geoips2.dev.boundaries.is_valid_boundaries for full list of supported boundaries dictionary formats
...
def get_boundaries_type(boundaries_name):
    ...
    Retrieve boundaries_dict_type of the requested boundaries, found in:
           geoips2.dev.boundaries.get_boundaries(boundaries_name)['boundaries_dict_type']

    See: geoips2.dev.boundaries.is_valid_boundaries for full list of supported boundaries dict types.
...
def list_boundaries_by_type():
    ...
    See geoips2.dev.boundaries.is_valid_boundaries? for a list of available boundaries types and associated dictionary formats.
    See geoips2.dev.boundaries.get_boundaries(boundaries_name) to retrieve the boundaries parameter dictionary
    ...
    from geoips2.geoips2_utils import list_boundaries_params_dict_yamls
...
def test_boundaries_interface():
    ''' Finds and opens every boundaries params dict available within the current geoips2 instantiation

    See geoips2.dev.boundaries.is_valid_boundaries? for a list of available boundaries params dict types and associated call signatures / return values.
    See geoips2.dev.boundaries.get_boundaries(boundaries_params_dict_name) to retrieve the requested boundaries params dict

    Returns:
        (list) : List of all successfully opened geoips2 boundaries params dicts
    '''
