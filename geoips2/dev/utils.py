...
''' Interface Under Development.  Please provide feedback to geoips@nrlmry.navy.mil
    ...
    General utilities for geoips2 development and processing

    As utility functions are finalized, they will be moved to
    geoips2/stable/utils.py module.
'''
...
def replace_geoips_paths(fname, replace_paths=None, base_paths=None):
    ''' Replace standard environment variables with their non-expanded equivalents.
        Ie, replace
            $HOME/geoproc with $GEOIPS2_BASEDIR
    ...
    Args:
        ...
        replace_paths (list) :  DEFAULT: None -> ['GEOIPS_OUTDIRS', 'GEOIPS2_BASEDIR']
                                Explicit list of standard variable names you would like replaced.
        base_paths (list) : DEFAULT: None -> geoips2.filenames.base_paths
    ...
    from geoips2.filenames.base_paths import PATHS as geoips2_gpaths
    if base_paths is None:
        base_paths = [geoips2_gpaths]
    ...
    if replace_paths is None:
        replace_paths = ['GEOIPS_OUTDIRS', 'GEOIPS2_BASEDIR']
